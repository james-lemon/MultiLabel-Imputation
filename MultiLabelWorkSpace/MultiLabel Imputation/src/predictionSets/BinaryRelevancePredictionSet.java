...
public class BinaryRelevancePredictionSet implements IPredictValueSet {
	...
	public ArrayList<IPredictValues> GetPredictValues() throws InvalidDataException, ModelInitializationException, Exception{
			...
			{
				output.add(new BinaryRelevancePredict("BinaryRelevance with " +classifier.getClass().toString(), classifier));
			}
			return output;
			}
	...
	{
		// None tested with Binary Relevance
		// Run well
		//classifiers.add(new ClassificationViaRegression());
		//classifiers.add(new J48());
		//TODO IF TIMEclassifiers.add(new MultilayerPerceptron());
