...
public class LabelPowerSetPredict implements IPredictValues {

	private String _name;
	private Classifier _classifer;
	
	public LabelPowerSetPredict(String name, Classifier classifier)
	{
		_name = name;
	...
	public PredictionsWithExperiment Run(MultiLabelInstances data) throws Exception {
		LabelPowerset model = new LabelPowerset(_classifer);
		  model.build(data);
