...
public class CalibratedLabelRankingPredict implements IPredictValues {

	private String _name;
	private Classifier _classifer;
	
	public CalibratedLabelRankingPredict(String name, Classifier classifier)
	{
		_name = name;
	...
	public PredictionsWithExperiment Run(MultiLabelInstances data) throws Exception {
		  CalibratedLabelRanking model = new CalibratedLabelRanking(_classifer);
		  model.build(data);
