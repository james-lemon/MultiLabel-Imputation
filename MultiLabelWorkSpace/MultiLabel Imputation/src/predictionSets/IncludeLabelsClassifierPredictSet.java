...
public class IncludeLabelsClassifierPredictSet implements IPredictValueSet {
	...
	public ArrayList<IPredictValues> GetPredictValues() throws InvalidDataException, ModelInitializationException, Exception{
			...
			{
				output.add(new IncludeLabelsClassifierPredict("IncludeLabelsClassifier with " +classifier.getClass().toString(), classifier));
			}
			return output;
			}
